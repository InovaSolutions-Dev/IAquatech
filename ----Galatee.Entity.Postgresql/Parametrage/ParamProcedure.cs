...
;
        ...
        public static DataTable PARAM_CODEDEPART_RETOURNE()
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
        ...
        public static DataTable PARAM_CODEDEPART_RETOURNEByCode(int pId)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())

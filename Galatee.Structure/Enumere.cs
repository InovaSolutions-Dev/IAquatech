...
namespace Galatee.Structure
{
    public static class Enumere
    {
        ...
        public static string EtatDeCaisseAutreUserSurCaisse = "EtatDeCaisseAutreUserSurCaisse";
        ...
        public static int LongueurMaxiBanchementSansSupplement;
        public static int MontantEspeceMiniSousFraisTimbre;
        public static int TauxFraisTimbreEspece;

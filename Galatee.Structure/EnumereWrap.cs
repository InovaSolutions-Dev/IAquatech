...
namespace Galatee.Structure
{
    ...
    public class EnumereWrap
    {
        ...
        // EtatDeCaisse
         ...
         [DataMember] public string EtatDeCaisseAutreUserSurCaisse { get; set; }
   ...
   //Code evenement
       [DataMember] public string EvenementCodeNormale { get; set; }
        ...
        //
         ...
         [DataMember] public int LongueurMaxiBanchementSansSupplement { get; set; }
         [DataMember] public int MontantEspeceMiniSousFraisTimbre { get; set; }
         [DataMember] public int TauxFraisTimbreEspece { get; set; }

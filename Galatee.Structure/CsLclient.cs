...
namespace Galatee.Structure
{
    ...
    public class CsLclient : CsPrint
    {
       ...
       [DataMember] public Nullable<System.DateTime>    DATETRANS { get; set; }
        ...
        [DataMember] public string sDATEFAC { get; set; }
        [DataMember] public string sDATEEXIG { get; set; }
        [DataMember] public string sDATEDEBUT { get; set; }
        [DataMember] public string sDATEFIN { get; set; }

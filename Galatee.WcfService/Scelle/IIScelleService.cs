...
namespace WcfService
{
    ...
    public interface IIScelleService
    {
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        string InsertAffectionScelle(int id_lademande, int IdUser, int idEtapeActuelle, string Matricule, List<CsLotScelle> LstLotScelle);
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        int InsertCompteur(List<CsCompteurBta> sCompteur);

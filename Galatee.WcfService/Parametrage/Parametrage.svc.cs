...
namespace WcfService
{
    ...
    public class Parametrage : IParametrage
    {
        ...
        public List<CParametre> RetourneTypeFacturation()
        {
            try
            {
                return new DB_CASIND().ChargerTypeFacturation();
            }
            catch (Exception ec)
            {
                string error = ec.Message;
        ...
        public List<CsGroupeValidation> SelectGroupeValidationByUserId(int UserId)
        {
            try
            {
                ...
                var huumm = new DB_WORKFLOW().SelectAllGroupeValidation();
        ...
        */
        ...
        public List<CsVwJournalDemande> RetourneDemandeWkfEtape(List<int> lstCentreId, int Fk_idetape, string matriculeUser)
        {
            try
            {
                List<CsVwJournalDemande> lstDemandeEtape = new DB_WORKFLOW().RetourneDemandeWkfEtape(lstCentreId,Fk_idetape,matriculeUser).Where(t => lstCentreId.Contains(t.FK_IDCENTRE)).ToList();

...
namespace WcfService
{
    ...
    public interface IAdministrationService
    {
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        //List<CsLclient> GenererFichierImpayes(int idSite, int idCentre);
        bool GenererFichierImpayes(int idSite, int idCentre, string nomposte);



        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsLclient> SelectSoldeFacture(string nomposte);



        [OperationContract]
        [FaultContract(typeof(Errors))]
        bool InsererPaiementMobile(List<CsLclient> Factures);

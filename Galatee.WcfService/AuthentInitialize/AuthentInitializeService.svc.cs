...
namespace WcfService
{
    ...
    public class AuthentInitializeService : IAuthentInitializeService
    {
        ...
        public EnumereWrap returnEnumereWrapper()
        {
            try
            {
                ErrorManager.WriteInLogFile(this, "Debut traitement");

                List<CsParametresGeneraux> param = new DB_ParametresGeneraux().SelectAllParametresGeneraux();

                ErrorManager.WriteInLogFile(this, "Suite traitement");
                ...
                Enumere.NationnaliteMali = param.FirstOrDefault(p => p.CODE == "000412").LIBELLE;
                Enumere.LongueurMaxiBanchementSansSupplement = string.IsNullOrEmpty(param.FirstOrDefault(p => p.CODE == "000413").LIBELLE) ? 20 : int.Parse(param.FirstOrDefault(p => p.CODE == "000413").LIBELLE);
                ...
                Enumere.TauxFraisTimbreEspece = string.IsNullOrEmpty(param.FirstOrDefault(p => p.CODE == "000415").LIBELLE) ? 1 : int.Parse(param.FirstOrDefault(p => p.CODE == "000415").LIBELLE);
                Enumere.LongueurMaxiBanchementSansSupplement = int.Parse(param.FirstOrDefault(p => p.CODE == "000413").LIBELLE);
                ...
                EnumereWrap wrapEnumere = new EnumereWrap()
                {
                    ...
                    EtatDeCaisseAutreUserSurCaisse = Enumere.EtatDeCaisseAutreUserSurCaisse,
                    ...
                    LongueurMaxiBanchementSansSupplement = Enumere.LongueurMaxiBanchementSansSupplement,
                    MontantEspeceMiniSousFraisTimbre = Enumere.MontantEspeceMiniSousFraisTimbre,
                    TauxFraisTimbreEspece = Enumere.TauxFraisTimbreEspece,

...
namespace WcfService
{
    ...
    public interface IReportService 
    {
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsStatFact> ReturneStatistique(int idSite, int idCentre, int idSecteur, int idProduit, int idCategorie, string periode, bool estIsolee, bool annee);


        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsLclient> VolumeEncaissement(int idSite, int idCentre, int idMode, int idCategorie, DateTime debut, DateTime fin);

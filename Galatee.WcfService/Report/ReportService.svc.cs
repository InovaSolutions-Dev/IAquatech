...
namespace WcfService
{
   ...
   [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)] 
    ...
    public class ReportService: IReportService
    {
       ...
       {
           return new DBReports().ReturneStatistique(idSite, idCentre, idSecteur, idProduit, idCategorie, periode, estIsolee, annee);
       }


       public List<CsLclient> VolumeEncaissement(int idSite, int idCentre, int idMode, int idCategorie, DateTime debut, DateTime fin)
       {
           return new DBReports().ReturneVolumeEncaissement(idSite, idCentre, idMode, idCategorie, debut, fin);
       }

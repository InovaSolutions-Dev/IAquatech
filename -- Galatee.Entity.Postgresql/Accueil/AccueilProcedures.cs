    ...
    public static class AccueilProcedures
    {
            ...
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    select new
                    {
                        ...
                        x.USERMODIFICATION,
                        x.PK_ID,
                        QUARTIER = x.QUARTIER.CODE,
                        FK_IDQUARTIER = x.FK_IDQUARTIER
                    };
                    return Galatee.Tools.Utility.ListToDataTable(query);
                }
            }
        ...
        public static DataTable RetournePosteTransformateur()
        {
            try
            {
                ...
                {
                    IEnumerable<object> query = null;
                    var _LstPoste = context.POSTETRANSFORMATION ;
                    query =
                    from x in _LstPoste
                    select new
                    {
       ...
       public static DataTable RetourneScellageCompteur(string numero,string marque)
        ...
        public static DataTable RetourneListeDemandeCritere_(int? pCentre, string pNumdem, List<string> LstTdem, DateTime? pDatedebut, DateTime? pDateFin,
                                DateTime? pDatedemande, string pNumerodebut, string pNumerofin, string pStatus, string Commune, string Quatier, string Secteur, string Rue, string Porte, string Etage, string NumeroLot)
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_DABON";
            try
            {

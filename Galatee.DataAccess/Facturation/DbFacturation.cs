    ...
    string centreStop, string clientStop, string periodeSelectionne,  bool IsLotIsole)
        ...
        public List<CsFactureClient> EditionFactureEau(List<CsEnteteFacture> lstEnteteFacture, List<CsProduitFacture> lstProduitFacture, List<CsRedevanceFacture> lstRedevanceFacture)
        {
            ...
            try
            {
                ...
                if (Enumere.MontantEspeceMiniSousFraisTimbre == 0)
                {
                    List<CsParametresGeneraux> param = new DB_ParametresGeneraux().SelectAllParametresGeneraux();
                    Enumere.MontantEspeceMiniSousFraisTimbre = string.IsNullOrEmpty(param.FirstOrDefault(p => p.CODE == "000414").LIBELLE) ? 100000 : int.Parse(param.FirstOrDefault(p => p.CODE == "000414").LIBELLE);
                }
                ...
                foreach (CsEnteteFacture item in lstEnteteFacture.Where(t => (t.TOTFTTC != null && t.TOTFTTC != 0)).ToList())
                {
                    ...
                    //else
                    //    FactureEditeInit.MontantTimbre = 0;
                    FactureEditeInit.MontantTimbre = (item.TOTFTTC.Value >= Convert.ToDecimal(Enumere.MontantEspeceMiniSousFraisTimbre)) ? ((Convert.ToDecimal(Enumere.TauxFraisTimbreEspece) / 100) * item.TOTFTTC.Value) : (decimal)0;
                    ...
                    if (lstImpaye != null)  // Rapel impayes du client
                    {
                        ...
                        foreach (CsLclient itemimpayes in lstImpaye.OrderByDescending(t => t.REFEM))
                        {
                            ...
                            /*if (leFraistimbre != null)
                                ...
                                FactureEdite.MontantTimbre = 0;*/
                            FactureEdite.MontantTimbre = (item.TOTFTTC.Value >= Convert.ToDecimal(Enumere.MontantEspeceMiniSousFraisTimbre)) ? ((Convert.ToDecimal(Enumere.TauxFraisTimbreEspece) / 100) * item.TOTFTTC.Value) : (decimal)0;
                    ...
                    foreach (CsProduitFacture items in entfacs._LstProfact)
                    {
                        ...
                        FactureEditee.MontantTimbre = (item.TOTFTTC.Value >= Convert.ToDecimal(Enumere.MontantEspeceMiniSousFraisTimbre)) ? ((Convert.ToDecimal(Enumere.TauxFraisTimbreEspece) / 100) * item.TOTFTTC.Value) : (decimal)0;
                        ...
                        FactureEditeeesVide.MontantTimbre = (item.TOTFTTC.Value >= Convert.ToDecimal(Enumere.MontantEspeceMiniSousFraisTimbre)) ? ((Convert.ToDecimal(Enumere.TauxFraisTimbreEspece) / 100) * item.TOTFTTC.Value) : (decimal)0;
                        ...
                        FactureEditees.MontantTimbre = (item.TOTFTTC.Value >= Convert.ToDecimal(Enumere.MontantEspeceMiniSousFraisTimbre)) ? ((Convert.ToDecimal(Enumere.TauxFraisTimbreEspece) / 100) * item.TOTFTTC.Value) : (decimal)0;
                        ...
                        */
                        ...
                        FactureEditeeesVide1.MontantTimbre = (item.TOTFTTC.Value >= Convert.ToDecimal(Enumere.MontantEspeceMiniSousFraisTimbre)) ? ((Convert.ToDecimal(Enumere.TauxFraisTimbreEspece) / 100) * item.TOTFTTC.Value) : (decimal)0;

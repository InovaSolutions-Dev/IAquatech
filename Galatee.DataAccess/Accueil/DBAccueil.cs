...
namespace Galatee.DataAccess
{
    public class DBAccueil
    {
        ...
        public List<CsCentre> ChargerLesDonneesDesSite(bool IsIncrementeDemandeNum)
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_DONNEESSITE";
            try
            {
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneDonneesSite();
                List<CsCentre> _LstCentre = Entities.GetEntityListFromQuery<CsCentre>(dt);
                ...
                List<CsProduit> _LstProduit = Entities.GetEntityListFromQuery<CsProduit>(dtp);
        ...
        public List<CsCommune>   ChargerLesCommune()
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_COMMUNE";
            try
            {
        ...
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_TARIF";
            try
            {
        ...
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_FORFAIT";
            try
            {
        ...
        public List<CsProduit >     RetourneListeProduit()
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_OPTIONDEMANDE";
            try
            {
        ...
        public List<CsTypeBranchement > RetourneTypeDeBranchement()
        {
            try
            {
                DataTable dt = Galatee.Entity.Model.CommonProcedures.RetourneTypeDeBranchement();
        ...
        public List<CsMois > RetourneTousMois()
        {
            try
            {
        ...
        public List<CsFrequence > RetourneTousFrequence()
        {
            try
            {
        ...
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_TYPEBRANCHEMENT";
            try
            {
        ...
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_PUISSANCE";
            try
            {
       ...
       public List<CsClientRechercher> RechercherClientCompteur(string NumCompteur)
        ...
        public CsDemandeBase RetourneDemandeClientType(CsClient leClient)
        {
            ...
            {
                List<CsDemandeBase> _lstDemande = new List<CsDemandeBase>();
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneDemandeClientType(leClient.CENTRE,leClient.REFCLIENT, leClient.ORDRE, (int)leClient.FK_IDCENTRE, leClient.TYPEDEMANDE);
                _lstDemande = Entities.GetEntityListFromQuery<CsDemandeBase>(dt);
                if (_lstDemande != null && _lstDemande.Count != 0)
                    return _lstDemande.OrderByDescending(r => r.DATECREATION).FirstOrDefault();
                else
                    return null;
            }
            catch (Exception ex)
       ...
       public List<CsDemandeBase >  RetourneListeDemandeClient(int pIdCentre, string pCentre, string pClient, string pOrdre)
        {
            ...
            {
                List<CsDemandeBase> _lstDemande = new List<CsDemandeBase>();
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneListeDemandeClient(pIdCentre, pCentre, pClient, pOrdre);
                _lstDemande = Entities.GetEntityListFromQuery<CsDemandeBase>(dt);
                return _lstDemande.OrderByDescending (t => t.DATECREATION ).ToList();
            }
            catch (Exception ex)
            {
...
*/
        ...
        public List<CsLclient> ChargerCompteDeResiliation(CsClient  leClient)
        {
            ...
            //if (lstFactiureAvc.DENR != new DateTime() && lstFactiureAvc.SOLDEFACTURE != 0 && lstFactiureAvc.SOLDEFACTURE != null) //ZEG 14/02/2019
            //{
            DataTable dte = null;//ZEG 14/02/2019
            if (lstFactiureAvc != null && lstFactiureAvc.SOLDEFACTURE != null && lstFactiureAvc.SOLDEFACTURE > 0) //ZEG 14/02/2019
                dte = AccueilProcedures.RetourneFactureAvanceFromAbon(lstFactiureAvc.FK_IDCENTRE, lstFactiureAvc.CENTRE, lstFactiureAvc.CLIENT, lstFactiureAvc.ORDRE, lstFactiureAvc.DENR, lstFactiureAvc.MONTANT.Value);

            if (dte == null)//ZEG 14/02/2019
                return null;
        ...
        public CsDemande RetourneDetailDemandeFromDEvis(CsDemandeBase _laDemande)
        {
            ...
            try
            {
                ...
                if (_laDemande.TYPEDEMANDE == Enumere.Resiliation && (_LaDemande.LstEvenement != null && _LaDemande.LstEvenement.Count == 0))
                {
                    ...
                    List<CsEvenement> lstEvt = new DbFacturation().RetourneEvenement(_LaDemande.LeClient);
                    if (lstEvt.Count != 0)
                    {
                ...
                _LaDemande.LstFraixParticipation = Entities.GetEntityListFromQuery<CsFraixParticipation>(dtparticipation);
                 ...
                 _LaDemande.InfoDemande = new DB_WORKFLOW().RecupererInfoDemandeParCodeTDem(_laDemande);
                 _LaDemande.LstCommentaire = new DB_WORKFLOW().SelectCommentaireRejet(_laDemande.NUMDEM );
                ...
                _LaDemande.Programmation = RetoureDetailProgramme(_laDemande.PK_ID);
        ...
        public List<CsBrt> RetourneBranchement(int fk_idcentre, string centre, string client, string produit)
        {
            ...
            try
            {
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneBRT (fk_idcentre, centre,client ,produit );
        ...
        public List<CsAbon> RetourneAbon(int fk_idcentre, string centre, string client, string ordre)
        {
            ...
            {
                galadbEntities ctx = new galadbEntities();
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneAbon(fk_idcentre,centre, client, ordre);
                List<CsAbon> lstAbon = Entities.GetEntityListFromQuery<CsAbon>(dt);
                List<MOIS> lstMois = ctx.MOIS.ToList() ;
                foreach (CsAbon  item in lstAbon)
                {
                    item.LIBELLEMOISIND = lstMois.FirstOrDefault(t => t.PK_ID == item.FK_IDMOISREL).LIBELLE;
                    item.LIBELLEMOISFACT  = lstMois.FirstOrDefault(t => t.PK_ID == item.FK_IDMOISFAC ).LIBELLE;  
                }
                return lstAbon;
        ...
        public CsClasseurClient RetourneClasseurClient(CsClientRechercher _LeClientRecherche)
        {
            try
            {
                 ...
                 _LeClasseur.Ag = RetourneAdresse(_LeClientRecherche.FK_IDCENTRE ,_LeClientRecherche.CENTRE, _LeClientRecherche.CLIENT, _LeClientRecherche.ORDRE);
                 ...
                 _LeClasseur.LstBranchement = RetourneBranchement(_LeClientRecherche.FK_IDCENTRE, _LeClientRecherche.CENTRE, _LeClientRecherche.CLIENT, null);
        ...
        public CsAg RetourneAdresse(int fk_idcentre, string centre, string client, string ordre)
        {
            ...
            try
            {
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneAG(fk_idcentre,centre, client, ordre);
       ...
       public  CsDemandeBase GetDemandeByNumIdDemande(int pIdDemande)
       {
           try
           {
               return Entities.GetEntityFromQuery<CsDemandeBase>(AccueilProcedures.GetDemandeByNumIdDemande(pIdDemande));
           }
           catch (Exception ex)
           {
               throw ex;
       ...
       public string RetourneOrdreMax(int fk_idcentre, string centre, string client, string produit)
       {
        ...
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_CLIENT";
            try
            {
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneClient(fk_idcentre,centre, client, ordre);
        ...
        public List<CsLclient> RetourneFactureClient(int fk_idcentre, string centre, string client, string ordre)
        {
            try
            {
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneFactureClient(fk_idcentre, centre, client, ordre);
        ...
        public List<CsLclient> RetourneEncaissementClient(int Fk_idcentre, string centre, string client, string ordre)
        {
            try
            {
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneEncaissement(Fk_idcentre,centre, client, ordre);
                return Entities.GetEntityListFromQuery<CsLclient>(dt);
            }
            catch (Exception ex)
            {
        ...
        public List<CsCodeTaxeApplication> RetourneTousApplicationTaxe()
        {
            try
            {
                DataTable dt = Galatee.Entity.Model.AccueilProcedures.RetourneTousApplicationTaxe();
                //DataTable dt = new DataTable();
        ...
        public CsCompteClient  RetourneLeCompteClient(int fk_idcentre, string centre, string client, string ordre)
        {
            try
            {
                ...
                List<CsLclient> lstImpaye = new DBEncaissement().RetourneListeFactureNonSolde(centre, client, ordre, _LstFacture.First().FK_IDCLIENT);
        ...
        public bool MiseAJourVariationPuissanceSansMetre(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                ...
                if (leAbon != null)
                {
                    leAbon.PUISSANCE = pDemande.Abonne.PUISSANCE;
        ...
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_TYPELOT";
            try
            {
        ...
        public List<CsOrigineLot > RetourneOrigine()
        {
            ...
            //cmd.CommandText = "SPX_GUI_RETOURNE_ORIGINELOT";
            try
            {
        ...
        */
                ...
                public CsProgarmmation  RetoureDetailProgramme(int IdDemande)
                {
                    try
                    {
                        cn = new SqlConnection(ConnectionString);
...
*/
            ...
            public List<CsLclient> GetImpayes(int idSite, int idCentre)
            {
                cn = new SqlConnection(ConnectionString);
                ...
                cmd.CommandTimeout = 1800;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SPX_GET_IMPAYES";
                if (cmd.Parameters != null && cmd.Parameters.Count != 0) cmd.Parameters.Clear();
                cmd.Parameters.Add("@FK_IDCODESITE", SqlDbType.Int).Value = idSite;
                cmd.Parameters.Add("@FK_IDCENTRE", SqlDbType.Int).Value = idCentre;
                DBBase.SetDBNullParametre(cmd.Parameters);
                try
                {
            ...
            public List<CsLclient> SoldeFactures(List<CsLclient> Factures)
            {
                cn = new SqlConnection(ConnectionString);
                ...
                cmd.CommandTimeout = 1800;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SPX_GET_SOLDEFACTURE";

                try
                {
                    List<CsLclient> Liste = new List<CsLclient>();
                    CsLclient facture = null;

                    foreach (CsLclient st in Factures)
                    {
                        facture = new CsLclient();

                        if (cmd.Parameters != null && cmd.Parameters.Count != 0) cmd.Parameters.Clear();
                        cmd.Parameters.Add("@CENTRE", SqlDbType.VarChar, 3).Value = st.CENTRE;
                        cmd.Parameters.Add("@CLIENT", SqlDbType.VarChar, 20).Value = st.CLIENT;
                        cmd.Parameters.Add("@ORDRE", SqlDbType.VarChar, 2).Value = st.ORDRE;
                        cmd.Parameters.Add("@REFEM", SqlDbType.VarChar, 6).Value = st.REFEM;
                        cmd.Parameters.Add("@NDOC", SqlDbType.VarChar, 6).Value = st.NDOC;
                        DBBase.SetDBNullParametre(cmd.Parameters);
                        ...
                        DataTable dt = new DataTable();
                        dt.Load(reader);
                        facture = Entities.GetEntityFromQuery<CsLclient>(dt);

                        if (facture != null)
                        {
                            facture.MONTANT = st.MONTANT;
                            facture.DENR = st.DENR;
                            facture.ACQUIT = st.ACQUIT;
                            facture.IDLOT = st.IDLOT;
                            facture.MONTANTEXIGIBLE = st.MONTANTEXIGIBLE;
                            Liste.Add(facture);
                        }
                    }
                    return Liste;
        ...
        public bool InsererPaiementsMobile(List<CsLclient> Factures)
        {
            SqlCommand laCommande = DBBase.InitTransaction(ConnectionString);
            try
            {
                foreach (CsLclient item in Factures)
                {
                    InsererPaiement(item, laCommande);
                }
                laCommande.Transaction.Commit();
                return true;
            }
...
*/
        ...
        public CsDemandeBase CreeDemande(CsDemande laDemande, bool AvecTransmission)
        {
            ...
            try
            {
                ...
                {
                    CsClient cli = Select_client(laDemande.LaDemande.FK_IDCENTRE, laDemande.LaDemande.CENTRE, laDemande.LaDemande.CLIENT, laDemande.LaDemande.ORDRE);
                    if (cli != null)
                    {
                ...
                if (AvecTransmission)
                {
                    string CodeWkF = laDemande.LaDemande.SITE + laDemande.LaDemande.CENTRE + DateTime.Today.Year + DateTime.Today.Month + DateTime.Today.Day + DateTime.Today.Hour +
                                     DateTime.Now.Minute + DateTime.Now.Second + DateTime.Now.Millisecond;
                    CreeDemande(laDemande.LaDemande.PK_ID, laDemande.LaDemande.NUMDEM, CodeWkF, laDemande.LaDemande.TYPEDEMANDE, laDemande.LaDemande.FK_IDTYPEDEMANDE, laDemande.LaDemande.FK_IDCENTRE, laDemande.LaDemande.CENTRE, laCommande);
                }
                laCommande.Transaction.Commit();
                return laDemande.LaDemande;
            }
        ...
        */
        ...
        public int InsertOrUpdateDCannalisation(CsCanalisation laCan, SqlCommand cmds)
        {
            cmds.CommandTimeout = 3000;
            cmds.CommandType = CommandType.StoredProcedure;
...
*/
        ...
        */
        ...
        public CsDemandeBase Select_Demande(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsAg Select_DAg(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsAbon Select_DAbon(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsBrt Select_Dbrt(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsClient Select_Dclient(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<CsCanalisation> Select_DCannalisationInCompteur(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<CsCanalisation> Select_DCannalisationInDCompteur(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<CsCanalisation> Select_DCanalisationInMagazin(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<CsDemandeDetailCout> Select_FactureDemande(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<ObjELEMENTDEVIS> Select_ElementDevis(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsSocietePrive Select_DSocietePrive(int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsPersonePhysique Select_DPersonnePhysique(int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsAdministration_Institut Select_DAdministration_Institut(int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<ObjAPPAREILSDEVIS> Select_Appareil(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<CsAnnotation> Select_Annotation(int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
...
*/
        ...
        public List<ObjELEMENTDEVIS> RetourneMaterielDevis()
        {
            cn = new SqlConnection(ConnectionString);
            ...
            cmd.CommandText = "SPX_ACC_SELECTMATERIELDEVIS";
            DBBase.SetDBNullParametre(cmd.Parameters);
            try
            {
                if (cn.State == ConnectionState.Closed)
        ...
        public CsAg Select_Ag(int IdCentre, string Centre, string Client)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsAbon Select_Abon(int IdCentre, string Centre, string Client, string Ordre)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsBrt Select_brt(int IdCentre, string Centre, string Client)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsClient Select_client(int IdCentre, string Centre, string Client, string Ordre)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public List<CsCanalisation> Select_CannalisationCompteur(int IdCentre, string Centre, string Client)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsSocietePrive Select_SocietePrive(int Fk_idclient)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsPersonePhysique Select_PersonnePhysique(int Fk_idclient)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsAdministration_Institut Select_Administration_Institut(int Fk_idclient)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public CsInfoProprietaire Select_InformationPropriete(string NumDem, int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
        ...
        public string ValiderAffectation(List<CsAffectationDemandeUser> lstAffectation)
        {
            ...
            try
            {
                ...
                {
                    CsDemandeBase LaDemande = Select_Demande(item.CODEDEMANDE, item.FK_IDDEMANDE);
        ...
        public string ProcesVerbal(CsDemande laDemande, bool Istransmetre)
        {
            ...
            try
            {
                    ...
                    laDemande.LaDemande.TYPEDEMANDE == Enumere.Reabonnement)
                {
                    ...
                    if (laDemande.LstCanalistion != null)
                        foreach (CsCanalisation item in laDemande.LstCanalistion)
                        {
                            ...
                            item.FK_IDABON = laDemande.Abonne.PK_ID;
                            item.FK_IDCOMPTEUR = IdCompteur;
                            item.FK_IDPROPRIETAIRE = laDemande.LeClient.FK_IDPROPRIETAIRE;
                            item.PROPRIO = laDemande.LeClient.PROPRIO;
                            item.CLIENT = laDemande.LaDemande.CLIENT;
                            item.NUMDEM = laDemande.LaDemande.NUMDEM;
                            item.FK_IDDEMANDE = laDemande.LaDemande.PK_ID;
                            #endregion
                            item.PK_ID = InsertOrUpdateDCannalisation(item, laCommande);
                ...
                if (laDemande.LaDemande.TYPEDEMANDE == Enumere.ChangementProduit)
                {
                    ...
                    CsAg ag = Select_Ag(laDemande.LaDemande.FK_IDCENTRE, laDemande.LaDemande.CENTRE, laDemande.LaDemande.CLIENT);
                    CsAg dag = Select_DAg(laDemande.LaDemande.NUMDEM, laDemande.LaDemande.PK_ID);
                    ...
                    CsClient client = Select_client(laDemande.LaDemande.FK_IDCENTRE, laDemande.LaDemande.CENTRE, laDemande.LaDemande.CLIENT, laDemande.LaDemande.ORDRE);
                    ...
                    */
                    ...
                    CsAbon abon = Select_Abon(laDemande.LaDemande.FK_IDCENTRE, laDemande.LaDemande.CENTRE, laDemande.LaDemande.CLIENT, laDemande.LaDemande.ORDRE);
                    ...
                    List<CsCanalisation> lcanal = Select_CannalisationCompteur(laDemande.LaDemande.FK_IDCENTRE, laDemande.LaDemande.CENTRE, laDemande.LaDemande.CLIENT);
                    ...
                    CsAbon dabon = Select_DAbon(laDemande.LaDemande.NUMDEM, laDemande.LaDemande.PK_ID);
                ...
                if (laDemande.LaDemande.TYPEDEMANDE == Enumere.AbonnementSeul)
                {
                    ...
                    CsBrt brt = Select_brt(laDemande.LaDemande.FK_IDCENTRE, laDemande.LaDemande.CENTRE, laDemande.LaDemande.CLIENT);
                    CsBrt dbrt = Select_Dbrt(laDemande.LaDemande.NUMDEM, laDemande.LaDemande.PK_ID);
...
*/
        ...
        public CsDemande ChargerDetailClient(int fk_idcentre, string centre, string client, string ordre, string produit, string Typedemande)
        {
            ...
            {
                CsDemande _LaDemande = new CsDemande();
                _LaDemande.Ag = Select_Ag(fk_idcentre, centre, client);
                _LaDemande.LeClient = Select_client(fk_idcentre, centre, client, ordre);
                if (_LaDemande.LeClient != null && !string.IsNullOrEmpty(_LaDemande.LeClient.NOMABON))
                {
                    _LaDemande.SocietePrives = Select_SocietePrive(_LaDemande.LeClient.PK_ID);
                    _LaDemande.AdministrationInstitut = Select_Administration_Institut(_LaDemande.LeClient.PK_ID);
                    _LaDemande.PersonePhysique = Select_PersonnePhysique(_LaDemande.LeClient.PK_ID);
                }
                _LaDemande.Abonne = Select_Abon(fk_idcentre, centre, client, ordre);
                _LaDemande.Branchement = Select_brt(fk_idcentre, centre, client);
                List<CsCanalisation> lstCan = Select_CannalisationCompteur(fk_idcentre, centre, client);
                if (lstCan != null && lstCan.Count != 0)
                {
                    _LaDemande.LstCanalistion = new List<CsCanalisation>();
        ...
        */
        ...
        public CsOrdreTravail Select_DOrdreDeTravail(int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
            cmd = new SqlCommand();
            cmd.Connection = cn;
                ...
                if (_LaDemande.LaDemande != null && !string.IsNullOrEmpty(_LaDemande.LaDemande.TYPEDEMANDE))
                {
                    ...
                    if (_LaDemande.LaDemande.TYPEDEMANDE == Enumere.Resiliation)
                    {
                        ...
                        */
                        ...
                        _LaDemande.LaDemande = Entities.GetEntityFromQuery<CsDemandeBase>(AccueilProcedures.GetDemandeByNumIdDemande(idDemande));
                        ...
                        if (_LaDemande.LeClient != null && _LaDemande.LeClient.PROPRIO == Enumere.LOCATAIRE)
                            _LaDemande.InfoProprietaire_ = Select_InformationPropriete(NumDemande, idDemande);
                    ...
                    else
                    {
                        ...
                        if (_LaDemande.LaDemande.TYPEDEMANDE == Enumere.ReprisIndex || _LaDemande.LaDemande.TYPEDEMANDE == Enumere.AnnulationFacture)
                        {
                            _LaDemande.LeClient = Select_Dclient(NumDemande, idDemande);
                        ...
                        else
                        {
                            ...
                            {
                                CsAbon abon = Select_Abon(int.Parse(_LaDemande.LeClient.FK_IDCENTRE.ToString()), _LaDemande.LeClient.CENTRE, _LaDemande.LeClient.REFCLIENT, _LaDemande.LeClient.ORDRE);
                                ...
                                (_LaDemande.LaDemande.TYPEDEMANDE == Enumere.AbonnementSeul && _LaDemande.LaDemande.ISMETREAFAIRE))
                            {
                                ...
                                if (_LaDemande.LaDemande.TYPEDEMANDE == Enumere.BranchementAbonementExtention)
                                    _LaDemande.OrdreTravail = Select_DOrdreDeTravail(idDemande);
                            }
                            else if (_LaDemande.LaDemande.TYPEDEMANDE == Enumere.ModificationCompteur)
                                _LaDemande.LstCanalistion = Select_DCannalisationInDCompteur(NumDemande, idDemande);
                            else
                            ...
                            {
                                CsAg ag = Select_Ag(_LaDemande.LaDemande.FK_IDCENTRE, _LaDemande.LaDemande.CENTRE, _LaDemande.LaDemande.CLIENT);
        ...
        public void InsererPaiement(CsLclient facture, SqlCommand cmds)
        {
            

            cmds.CommandTimeout = 3000;
            cmds.CommandType = CommandType.StoredProcedure;
            cmds.CommandText = "SPX_INTERFACE_PAIEMENT_INSERT";
            if (cmds.Parameters != null && cmds.Parameters.Count != 0) cmds.Parameters.Clear();
            cmds.Parameters.Add("@CENTRE", SqlDbType.VarChar, 3).Value = facture.CENTRE;
            cmds.Parameters.Add("@CLIENT", SqlDbType.VarChar, 20).Value = facture.CLIENT;
            cmds.Parameters.Add("@ORDRE", SqlDbType.VarChar, 2).Value = facture.ORDRE;
            cmds.Parameters.Add("@FACTURE", SqlDbType.VarChar, 6).Value = facture.NDOC;
            cmds.Parameters.Add("@PERIODE", SqlDbType.VarChar, 6).Value = facture.REFEM;
            cmds.Parameters.Add("@MONTANT", SqlDbType.Decimal).Value = facture.MONTANT;
            cmds.Parameters.Add("@DATE", SqlDbType.DateTime).Value = facture.DENR;
            cmds.Parameters.Add("@ACQUIT", SqlDbType.VarChar, 9).Value = facture.ACQUIT;
            cmds.Parameters.Add("@MATRICULE", SqlDbType.VarChar, 6).Value = facture.MATRICULE;
            cmds.Parameters.Add("@FK_IDLCLIENT", SqlDbType.Int).Value = facture.PK_ID;
        ...
        public void CreeDemande(int IDDEMANDE, string NUMDEM, string CODEDEMANDEWKF, string TYPEDEMANDE, int FK_IDTYPEDEMANDE, int FK_IDCENTRE, string CENTRE, SqlCommand cmds)
        {
            cmds.CommandTimeout = 3000;
            cmds.CommandType = CommandType.StoredProcedure;
            ...
            cmds.Parameters.Add("@TYPEDEMANDE", SqlDbType.VarChar, 2).Value = TYPEDEMANDE;
            cmds.Parameters.Add("@FK_IDTYPEDEMANDE", SqlDbType.Int).Value = FK_IDTYPEDEMANDE;
            cmds.Parameters.Add("@FK_IDCENTRE", SqlDbType.Int).Value = FK_IDCENTRE;
            cmds.Parameters.Add("@CENTRE", SqlDbType.VarChar, 3).Value = CENTRE;
        ...
        public List<CsFraixParticipation> Select_FraisParticipation(int Iddemande)
        {
            cn = new SqlConnection(ConnectionString);
            cmd = new SqlCommand();
            cmd.Connection = cn;

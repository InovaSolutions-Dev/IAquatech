...
namespace Galatee.DataAccess
{
    public class DBReports
    {
        ...
        public List<CsStatFact> ReturneStatistique(int idSite, int idCentre, int idSecteur, int idProduit, int idCategorie, string periode, bool estIsolee, bool annee)
        {
            try
            {
                ...
                cmd.CommandText = "SPX_RPT_STAT_FACT";
                cmd.Parameters.Add("@periode", SqlDbType.VarChar, 6).Value = periode;
                cmd.Parameters.Add("@idSite", SqlDbType.Int).Value = idSite;
                cmd.Parameters.Add("@idCentre", SqlDbType.Int).Value = idCentre;
                //cmd.Parameters.Add("@idSecteur", SqlDbType.Int).Value = idSecteur;
                //cmd.Parameters.Add("@idProduit", SqlDbType.Int).Value = idProduit;
                cmd.Parameters.Add("@idCategorie", SqlDbType.Int).Value = idCategorie;
                cmd.Parameters.Add("@estIsolee", SqlDbType.Bit).Value = estIsolee;
                cmd.Parameters.Add("@surAnnee", SqlDbType.Bit).Value = annee;
        ...
        public List<CsLclient> ReturneVolumeEncaissement(int idSite, int idCentre, int idMode, int idCategorie, DateTime debut, DateTime fin)
        {
            try
            {
                ...
                cmd.CommandTimeout = 1800;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SPX_RPT_VOLUME_ENCAISSEMENT";
                cmd.Parameters.Add("@idSite", SqlDbType.Int).Value = idSite;
                cmd.Parameters.Add("@idCentre", SqlDbType.Int).Value = idCentre;
                cmd.Parameters.Add("@idMode", SqlDbType.Int).Value = idMode;
                cmd.Parameters.Add("@idCategorie", SqlDbType.Int).Value = idCategorie;

...
namespace Galatee.DataAccess
{
    public class DBScelle
    {
        ...
        public List<CsDscelle> RetourneListeDemandeScelle(int fk_dem)
        {
            try
            {
                List<CsDscelle> _lstdemandescelle = new List<CsDscelle>();
                DataTable dt = Galatee.Entity.Model.ScelleProcedures.RetourneListeDemandeScelle(fk_dem);
                _lstdemandescelle = Entities.GetEntityListFromQuery<CsDscelle>(dt);

                return _lstdemandescelle.ToList();
        ...
        public List<CsDetailAffectationScelle> RetourneListeDetailAffectationScelle(int IdDemande)
        {
            try
            {
                List<CsDetailAffectationScelle> _lstScelle = new List<CsDetailAffectationScelle>();
                DataTable dt = Galatee.Entity.Model.ScelleProcedures.RetourneListeDetailAffectationScelle(IdDemande);
                _lstScelle = Entities.GetEntityListFromQuery<CsDetailAffectationScelle>(dt);
        ...
        public string InsertDemandeScelle(CsDemandeBase lademande, CsDscelle dscelle)
        {
            ...
            try
            {
                ...
                new DBAccueil().CreeDemande(lademande.PK_ID, lademande.NUMDEM, CodeWkF,lademande.TYPEDEMANDE, lademande.FK_IDTYPEDEMANDE,lademande.FK_IDCENTRE, lademande.CENTRE, laCommande);
...
*/
        ...
        */
        ...
        public List<CsActivite> RetourneListeActivite()
        {
            try
            {
                List<CsActivite> _lstActivite = new List<CsActivite>();
                DataTable dt = Galatee.Entity.Model.ScelleProcedures.RetourneListeActivite();
                _lstActivite = Entities.GetEntityListFromQuery<CsActivite>(dt);
        ...
        public CsRefOrigineScelle RefOrigineScelleByid(int Id_OrigineScelle)
        {
            try
            {
                ...
                List<CsRefOrigineScelle> _lstOrigineScelle = new List<CsRefOrigineScelle>();
                DataTable dt = Galatee.Entity.Model.ScelleProcedures.SCELLE_RefOrigineScelle_RETOURNEById(Id_OrigineScelle);
                _lstOrigineScelle = Entities.GetEntityListFromQuery<CsRefOrigineScelle>(dt);
        ...
        public List<CsCouleurActivite> RetourneListAllCouleurScelle()
        {
            try
            {
                List<CsCouleurActivite> _lstCouleur = new List<CsCouleurActivite>();
        ...
        public List<CsLotMagasinGeneral> SelectAllLotMagasinGeneral()
        {
            try
            {
                return Entities.GetEntityListFromQuery<CsLotMagasinGeneral>(ScelleProcedures.SCELLES_LotMagasinGeneral_RETOURNE());
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        */
        ...
        public List<CsLotScelle> RetourneListeScelle(int IdCentreRecuperationDeLot)
        {
            ...
            {
                List<CsLotScelle> _lstScelle = new List<CsLotScelle>();
                DataTable dt = Galatee.Entity.Model.ScelleProcedures.RetourneListeScelle(IdCentreRecuperationDeLot);
                _lstScelle = Entities.GetEntityListFromQuery<CsLotScelle>(dt);

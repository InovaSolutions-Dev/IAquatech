                            ...
                            menuItem.Name == "Galatee.Silverlight.Caisse.ListeEncaissementJournalière")
                        {
                           ...
                           || menuItem.Name == "Galatee.Silverlight.Caisse.FrmAnnulationEncaissement")
                            ...
                            cw = Activator.CreateInstance(cwType, new string[] { retourneTypeActionFacturation(menuItem.Title) });
                                 ...
                                 menuItem.Name == "Galatee.Silverlight.Administration.FrmFichierInterface" ||
                                 menuItem.Name == "Galatee.Silverlight.Administration.UcListeReglement" ||
                                 menuItem.Name == "Galatee.Silverlight.Report.FrmComptabilisation" ||
                                 menuItem.Name == "Galatee.Silverlight.Report.FrmStatistiquesVentes" ||
                                 menuItem.Name == "Galatee.Silverlight.Report.FrmStatistiquesEncaissement" ||
                    ...
                    case "400015":
                     ...
                     case "700013":
                      ...
                      case "50011":
                        ...
                        break;
                      case "40302":
                        _typeDemande = SessionObject.InterfacePaiement;
                        break;
                      case "40303":
                        _typeDemande = SessionObject.InterfaceTSP;
                        break;
                      case "40304":
                        _typeDemande = SessionObject.IntegrationReglement;
                        break;
                      case "40305":
                        _typeDemande = SessionObject.IntegrationIndexTsp;
                        break;
                      case "50012":
                        _typeDemande = SessionObject.StatfacturationStat;
                        break;
                      case "4":
                        _typeDemande = SessionObject.VolumeEncaissement;
                        break;
                      case "50001":
                        _typeDemande = SessionObject.Statfacturation;
                        break;
                      case "50002":
                        _typeDemande = SessionObject.StatfacturationIsolee;
                        break;
                      case "50013":

...
namespace Galatee.Silverlight
{
    public static class SessionObject
    {
        ...
        public static List<Galatee.Silverlight.ServiceCaisse.CsModereglement> LstDesModereg = new List<Galatee.Silverlight.ServiceCaisse.CsModereglement>();
        ...
        public static string InterfacePaiement = "40302";
        public static string IntegrationReglement = "40304";
        public static string IntegrationIndexTsp = "40305";
        public static string InterfaceTSP = "40303";
        public static string StatfacturationStat = "50012";
        public static string VolumeEncaissement = "4";
        public static string Statfacturation = "50001";
        public static string StatfacturationIsolee = "50002";
